...
//nolint:gosec // test scaffolding shells out to kubectl/make with test-controlled args
package e2e
...
const namespace = "image-distribution-operator-system"

// serviceAccountName created for the project
const serviceAccountName = "image-distribution-operator-controller-manager"

// metricsServiceName is the name of the metrics service of the project
const metricsServiceName = "image-distribution-operator-controller-manager-metrics-service"
	...
	Context("Manager", func() {
		...
		It("should ensure the metrics endpoint is serving metrics", func() {
			...
			cmd := exec.Command("kubectl", "create", "clusterrolebinding", metricsRoleBindingName,
				"--clusterrole=image-distribution-operator-metrics-reader",
